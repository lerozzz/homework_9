...
function f2() {
    const one = document.querySelector('.out-2');
    one.classList.add('bg-2');
}
...
function f3() {
    const one = document.querySelector('.out-3');
    one.classList.remove('bg-3');
}
...
function f4() {
    const one = document.querySelector('.out-4');
    one.classList.toggle('bg-4');
}
...
function f5() {
    const one = document.querySelector('.out-4');
    one.classList.toggle('bg-4');
    if (one.classList.contains('bg-4')) {
...
function f19() {
    ...
    let i = 0;
    while (i < a.length) {
        document.querySelector('.out-19').innerHTML += a[i].getAttribute('data-b') + ' ';
        i++;
    }
}
